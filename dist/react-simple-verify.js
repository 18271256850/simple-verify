...
(function(global, factory) {
  ...
  const ReactSimpleVerify = (function(_super) {
    ...
    // ReactSimpleVerify.prototype.touchstart = function(e) {
    //   if (e.target.offsetParent.className === 'verify-bar') {
    //     if (this.isSuccess) {
    //       return;
    //     }
    //     var touch = e.touches[0];
    //     this.x1 = Number(touch.clientX);
    //     this.isMousedown = true;
    //   }
    // };
    ReactSimpleVerify.prototype.touchmove = function(e) {
      if (e.target.offsetParent.className === 'verify-bar') {
        this.isMousedown = true;
      }
    ...
    ReactSimpleVerify.prototype.touchend = function(e) {
      if (this.isSuccess) {
        return;
      }
    ...
    ReactSimpleVerify.prototype.render = function() {
      ...
      return React.createElement(
        'div',
        { style: this.style, className: 'simple-verify' },
        React.createElement('div', { className: 'verify-tips' }, this.props.tips),
        React.createElement(
          'div',
          { style: this.slideBoxStyle, className: 'verify-box' },
        ...
        React.createElement(
          'div',
          { style: textStyle, className: 'verify-success-tips' },
